...
export const ProductCard: React.FC<Props> = ({ prefetchProduct, product, fullDescription = false }) => {
  
  return (
    <Link onMouseEnter={() => prefetchProduct && prefetchProduct(product.id)} to={`/product/${product.id}`}>
      <Card
